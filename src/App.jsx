...
function AddMemModal({onClose,onAdd,existing}){
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.4)",zIndex:2000,display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(8px)"}} onClick={onClose}>
  ...
  return (
    <div style={S.root}>
      ...
      <main style={{ paddingTop: 52, minHeight: "100vh" }}>
        ...
        {authModal==="profile" && (
          <>
            <div style={{ position:"fixed",inset:0,zIndex:1999 }} onClick={() => setAuthModal(null)} />
            <div className="scaleIn" style={{ position:"fixed",top:48,right:16,zIndex:2000,background:"rgba(255,255,255,0.97)",
